    ...
    return (
        ...
        >
            <div className="max-w-md mx-auto">
                ...
                >
                    <h2 className="text-3xl font-extrabold text-teal-600">Create New Event</h2>
                    <p className="mt-2 text-sm text-teal-500">Fill in the details to organize your event</p>
                </motion.div>
